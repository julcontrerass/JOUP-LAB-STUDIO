  ...
  const pillars = [
    {
      number: "01",
      title: "JOUP STUDIO",
      description: "La academia donde formamos a la nueva generación de profesionales del café.",
